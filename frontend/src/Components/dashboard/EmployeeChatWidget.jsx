...
const EmployeeChatWidget = () => {
    const [isOpen, setIsOpen] = useState(false);
    const [messages, setMessages] = useState([
        { role: 'ai', content: 'Hello! I am your Technical Mentor. I can help with coding, debugging, or explaining task requirements. How can I assist you?' }
    ]);
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const response = await api.post('/ai/employee-chat', {
        ...
        <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end">
            ...
            {isOpen && (
                <div className="mb-4 w-96 h-[500px] bg-white rounded-2xl shadow-2xl border border-gray-200 flex flex-col overflow-hidden animate-in slide-in-from-bottom-5 fade-in duration-300">
                    {/* Header */}
                    <div className="bg-gradient-to-r from-pink-500 to-rose-500 p-4 flex items-center justify-between shrink-0">
                    ...
                    <div className="p-3 bg-white border-t shrink-0">
                        <div className="flex items-center gap-2 bg-gray-100 rounded-xl px-2 py-1">
                            ...
                            <button
                                ...
                                className="p-2 bg-pink-500 text-white rounded-lg hover:bg-pink-600 disabled:opacity-50 transition-all"
                            >
            ...
            <button
                ...
                className={`p-4 rounded-full shadow-xl transition-all duration-300 flex items-center justify-center ${isOpen
                    ...
                    : 'bg-gradient-to-r from-pink-500 to-rose-500 text-white hover:scale-105 hover:shadow-2xl hover:shadow-pink-200'
                    }`}
            >
...
export default EmployeeChatWidget;
